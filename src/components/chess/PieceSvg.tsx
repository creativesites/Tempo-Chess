...
export const PieceSvg: React.FC<PieceProps> = ({ type, color, className = 'w-full h-full' }) => {
  ...
  switch (type) {
    case 'p':
      return (
        <svg viewBox="0 0 45 45" className={className} filter="drop-shadow(0 2px 3px rgba(0,0,0,0.25))">
          <path
